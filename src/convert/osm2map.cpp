...
int main(int argc, char *argv[])
{
    ...
    desc.add_options()
            ...
            ("date", po::value<string>()->notifier( [&writer](const string &value) { writer.setDate(value); }), "a date string otherwise current date")
            ("zoom-interval-conf", po::value<string>()->notifier( [&woptions](const string &value) { woptions.setZoomInterval(value); }), "a list of base_zoom, min_zoom, max_zoom for all levels of the map")
