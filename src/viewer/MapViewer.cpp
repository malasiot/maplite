    ...
    : QMainWindow(parent)
{
    ...
    mapadapter = new WMSMapAdapter("vision.iti.gr", 8080, "/geoserver/wms?service=WMS&version=1.1.0&request=GetMap&layers=stratoniko&styles=&bbox=%1,%2,%3,%4&srs=EPSG:4326&format=image/png");

    // create a layer with the mapadapter and type MapLayer
    mainlayer = new MapLayer("WMS-Layer", mapadapter);
    ...
    pts << QPointF(23.6, 40.51) << QPointF(23.8, 40.67) ;
    mc->setViewAndZoomIn(pts) ;
